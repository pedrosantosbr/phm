const ptPT = {
  ...
  hero: {
    ...
    body: "A PHMCare AI liga medicação, voz e prontuários numa única camada de inteligência clínica — reduzindo erros, custos administrativos e tempos de espera. Sem substituir o critério de quem cuida.",
    ctaPrimary: "Pedir demonstração",
    ctaGhost: "Ler o pitch",
    complianceGolive: "Go-live em 14 dias",
    specimen: {
      label: "Specimen 01 / MediGuard",
      header: "MediGuard · Pré-administração",
      meta: "00:38s · Enf.ª 4-B",
      patientLabel: "Doente · MRN 0–8814–73",
      patientName: "Sra. R. — 67 anos",
      severity: "Severidade",
      severityHigh: "Alta",
      prescription: "Prescrição",
      prescriptionDrug: "Cefepime 2g IV",
      allergyLabel: "Alergia",
      allergyDrug: "cefalosporinas",
      allergyYear: "· 2019",
      interactionLabel: "Interação",
      interactionDrug: "varfarina",
      interactionConsequence: "· INR ↑",
      recommendation: "Recomendação · evidência: A",
      recPart1: "Reter dose. Considerar",
      recDrug: "aztreonam",
      recPart2:
        "como alternativa em doente com hipersensibilidade documentada a β-lactâmicos.",
      source: "Fonte: IDSA 2024 · Protocolo local v3.2 · Histórico clínico",
      btnRetain: "Reter dose",
      btnJustify: "Justificar e administrar",
      latency: "latência 38ms",
      annotation:
        "Specimen ao vivo — toda recomendação inclui citação, latência medida e trilho de auditoria. Nada substitui o critério clínico; tudo o afia.",
    },
  },
  ...
  problem: {
    ...
    items: {
      meds: {
        title: "Erros de medicação por falta de contexto.",
        bodyPart1:
          "Alergias, interações e contraindicações estão registadas em sítios diferentes. À cabeceira do doente, a enfermagem decide com",
        bodyEmphasis: "fragmentos do quadro completo",
        bodyPart2: "— e cada falha tem consequências reais.",
        tag: "tag · medicação · BCMA · hipersensibilidade",
      },
      coding: {
      ...
      triage: {
        title: "Triagem dependente de call centers em rotura.",
        bodyPart1:
          "As decisões de prioridade clínica são tomadas em ambientes ruidosos, por pessoas sobrecarregadas, sem suporte em tempo real. O resultado é",
        bodyEmphasis: "triagem inconsistente",
        bodyPart2:
          "e tempo de espera que castiga primeiro quem mais precisa.",
        tag: "tag · manchester · urgência · agendamento · voz",
      },
      burnout: {
  ...
  platform: {
    ...
    body1:
      "A PHMCare AI integra-se ao seu EHR existente, escuta a voz, lê os prontuários, vigia a medicação — e devolve recomendações com citação, latência medida e trilho de auditoria.",
  ...
  products: {
    ...
    items: {
      mediguard: {
        ...
        specimen: {
          header: "Verificação · à cabeceira",
          patient: "Sra. R. · 67a · MRN 0–8814–73",
          severity: "Severidade",
          severityHigh: "Alta",
          allergyTitle: "Alergia · cefalosporinas",
          allergyMeta: "Documentada em 2019 · anafilaxia",
          interactionTitle: "Interação · varfarina",
          interactionMeta: "Risco de elevação do INR",
          sources: "14 fontes verificadas",
          retain: "RETER DOSE",
        },
      },
      codicare: {
      ...
      medicall: {
        ...
        bullet1: "Pré-triagem por voz alinhada com o protocolo de Manchester",
        bullet2:
        ...
        specimen: {
          header: "MediCall · em curso",
          transcriptLabel: "Transcrito · PT-PT",
          transcriptPart1: "Estou com",
          transcriptHighlight1: "dor no peito",
          transcriptPart2: "desde a manhã, tenho 67 anos e já senti",
          transcriptHighlight2: "falta de ar",
          transcriptPart3: "…",
          priorityLabel: "Prioridade · Manchester",
          priorityValue: "LARANJA · MUITO URGENTE",
          scheduledLabel: "Agendado",
          scheduledWhen: "Hoje · ",
          scheduledTime: "14:20",
          serviceLabel: "Serviço",
          serviceValue: "Urgência · Cardiologia",
        },
      },
    },
  },
  ...
  market: {
    ...
    cards: {
      ...
      valuation: {
        title: "Avaliação só em documentação clínica.",
        bodyPart1:
          "Empresas como Abridge ultrapassam os 5 mil milhões em avaliação. E é apenas",
        bodyEmphasis: "um",
  ...
  advantage: {
    ...
    categories: {
      docs: {
        ...
        body: "Capturam a voz do médico e geram nota clínica.",
      },
      voice: {
        label: "— Categoria 02",
        title: "IA de voz clínica",
        body: "Conversam, transcrevem, agendam. Fora do EHR ou em adapter.",
      },
      systems: {
        label: "— Categoria 03",
        title: "Sistemas clínicos",
        body: "EHRs e plataformas hospitalares. Profundas, lentas a evoluir.",
      },
    },
  ...
  model: {
    ...
    titleLine2: "utilização para a voz.",
    items: {
      saas: {
        title: "SaaS clínico",
      ...
      consumption: {
        title: "Consumo · MediCall",
        body: "Preço por minuto de chamada e por triagem completada. Escala com o volume, sem teto artificial.",
      },
      enterprise: {
  ...
  vision: {
    ...
    todayLabel: "Hoje",
    todayBody:
      "Segurança da medicação · codificação automática · triagem por voz.",
    nextLabel: "Próximo",
    nextBody:
  ...
  colophon: {
    ...
    images: {
      ...
      mediguard:
        "Composição abstracta minimalista: uma única linha fina vermelho-clay a atravessar um campo bone vasto, com um pico dramático único — como um EKG de anomalia. Espaço negativo generoso. Editorial fine-art. Sugere um sinal de consequência num campo de quietude. 4K.",
      codicare:
      ...
      medicall:
        "Close-up de uma forma de onda áudio rendered em tinta sobre linho — como uma gravação preservada. Espaço negativo amplo, uma linha clay a marcar o ponto de prioridade. Estética de impressão de museu. 4K.",
      model:
